                    ...
                    <div className="col col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                        ...
                        <div className="row g-3">
                            ...
                            <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                ...
                                <label htmlFor="" className="form-label">SSLC Marks (In %)</label>
                                <input type="number" name="" id="" className="form-control" />

                            </div>
                            <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">

                                <label htmlFor="" className="form-label">Plus Two Marks (In %)</label>
                                <input type="number" name="" id="" className="form-control" />
                            ...
                            <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                ...
                                <label htmlFor="" className="form-label">UG Degree Marks (In %)</label>
                                <input type="number" name="" id="" className="form-control" />
                            ...
                            <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                ...
                                <label htmlFor="" className="form-label">PG Degree Marks (In %)</label>
                                <input type="number" name="" id="" className="form-control" />
